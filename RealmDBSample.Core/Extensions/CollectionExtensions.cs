...
namespace RealmDBSample.Core.Extensions
{
    public static class CollectionExtensions
    {
        ...
        //public static IEnumerable<T> GetSubset<T>(IQueryable<T> items, int skip, int take)
        //{
        //    List<T> result = new List<T>(take);
        //    for(int index = skip; index < skip + take && index < result.Count; index++)
        //    {
